...
function ViewPlayerProfile:sendMagicExp(exp_tbid)
	...
	then
		...
		msg_box:showMsgBox1(self.ViewMgr.LanMgr:getLanValue("NotPlayer"),self.ViewMgr.LanMgr:getLanValue("SitTableSendMagic"),nil)
		return
	end
...
function ViewPlayerProfile:setPlayerInfo(player_info)
	...
	self.GTextPlayerNickName.text = CS.Casinos.UiHelper.addEllipsisToStr(self.PlayerInfo.PlayerInfoCommon.NickName,14,6)
