...
namespace XLua.CSObjectWrap
{
    ...
    public class CasinosSpineHelperWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Casinos.SpineHelper);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "LoadResourcesPrefab", _m_LoadResourcesPrefab_xlua_st_);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					Casinos.SpineHelper gen_ret = new Casinos.SpineHelper();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Casinos.SpineHelper constructor!");
