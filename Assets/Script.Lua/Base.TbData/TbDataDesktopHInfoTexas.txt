TbDataDesktopHInfoTexas = TbDataBase:new()

function TbDataDesktopHInfoTexas:new(id)
	o = {}
	setmetatable(o,self)
	self.__index = self
	o.Id = id
...
function TbDataDesktopHInfoTexas:load(list_datainfo)
...
TbDataFactoryDesktopHInfoTexas = TbDataFactoryBase:new()

function TbDataFactoryDesktopHInfoTexas:new(o)
	o = o or {}  
    setmetatable(o,self)  
    self.__index = self  		
...
function TbDataFactoryDesktopHInfoTexas:createTbData(id)
	return TbDataDesktopHInfoTexas:new(id)
end