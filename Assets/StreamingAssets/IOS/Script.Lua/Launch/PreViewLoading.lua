...
function ParticleHelper:GetParticel(path)
    ...
    if (particle == nil) then
        local particle_path = self.CasinosContext.PathMgr:combinePersistentDataPath(ViewHelper:getABParticleResourceTitlePath() .. path)
...
function ParticleHelper:GetSpine(path)
    ...
    if (spine == nil) then
        local spine_path = self.CasinosContext.PathMgr:combinePersistentDataPath(self.CasinosContext.ABResourcePathTitle .. path)
