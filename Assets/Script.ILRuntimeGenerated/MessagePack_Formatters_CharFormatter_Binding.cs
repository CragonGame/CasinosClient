...
{
    unsafe class MessagePack_Formatters_CharFormatter_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(MessagePack.Formatters.CharFormatter);
            ...
            app.RegisterCLRCreateArrayInstance(type, s => new MessagePack.Formatters.CharFormatter[s]);
        ...
        static StackObject* Serialize_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            MessagePack.Formatters.CharFormatter instance_of_this_method = (MessagePack.Formatters.CharFormatter)typeof(MessagePack.Formatters.CharFormatter).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        {
            return MessagePack.Formatters.CharFormatter.Instance;
        }
