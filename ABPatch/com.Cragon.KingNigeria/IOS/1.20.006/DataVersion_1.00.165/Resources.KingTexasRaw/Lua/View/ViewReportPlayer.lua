...
function ViewReportPlayer:setReportPlayerInfo(player_info)
    ...
    local level_ex = self.ViewMgr.LanMgr:getLanValue("等级:", "Level:")
	...
	then
		address = self.ViewMgr.LanMgr:getLanValue("未知֪", "Unknown")
	end
    address = self.ViewMgr.LanMgr:getLanValue("地址：", "Address") .. address
