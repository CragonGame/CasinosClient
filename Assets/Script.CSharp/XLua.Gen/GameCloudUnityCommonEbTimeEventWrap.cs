...
namespace XLua.CSObjectWrap
{
    ...
    public class GameCloudUnityCommonEbTimeEventWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(GameCloud.Unity.Common.EbTimeEvent);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					GameCloud.Unity.Common.EbTimeEvent gen_ret = new GameCloud.Unity.Common.EbTimeEvent();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to GameCloud.Unity.Common.EbTimeEvent constructor!");
        ...
        static int _g_get_mExpires(RealStatePtr L)
        {
		    try {
                ...
                GameCloud.Unity.Common.EbTimeEvent gen_to_be_invoked = (GameCloud.Unity.Common.EbTimeEvent)translator.FastGetCSObj(L, 1);
        ...
        static int _s_set_onTime(RealStatePtr L)
        {
		    try {
                ...
                GameCloud.Unity.Common.EbTimeEvent gen_to_be_invoked = (GameCloud.Unity.Common.EbTimeEvent)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.onTime = translator.GetDelegate<GameCloud.Unity.Common.EbTimeEvent.del>(L, 2);
