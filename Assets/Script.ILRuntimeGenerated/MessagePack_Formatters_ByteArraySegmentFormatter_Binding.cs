...
{
    unsafe class MessagePack_Formatters_ByteArraySegmentFormatter_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(MessagePack.Formatters.ByteArraySegmentFormatter);
            args = new Type[]{typeof(System.Byte[]).MakeByRefType(), typeof(System.Int32), typeof(System.ArraySegment<System.Byte>), typeof(MessagePack.IFormatterResolver)};
            ...
            app.RegisterCLRCreateArrayInstance(type, s => new MessagePack.Formatters.ByteArraySegmentFormatter[s]);
        ...
        static StackObject* Serialize_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.ArraySegment<System.Byte> @value = (System.ArraySegment<System.Byte>)typeof(System.ArraySegment<System.Byte>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            ...
            MessagePack.Formatters.ByteArraySegmentFormatter instance_of_this_method = (MessagePack.Formatters.ByteArraySegmentFormatter)typeof(MessagePack.Formatters.ByteArraySegmentFormatter).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        {
            return MessagePack.Formatters.ByteArraySegmentFormatter.Instance;
        }
