...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_Ping_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, DestroyPing_0);
            args = new Type[]{};
            ...
            app.RegisterCLRMethodRedirection(method, get_ip_3);



            app.RegisterCLRCreateArrayInstance(type, s => new UnityEngine.Ping[s]);
        ...
        static StackObject* DestroyPing_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
        ...
        static StackObject* get_ip_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
