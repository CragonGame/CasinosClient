...
function ViewMgr:onCreate(uipath_root,resourcesrow_pathroot)
	...
	CS.Casinos.CasinosContext.Instance.CasinosLua:doString("EventView")
	CS.Casinos.CasinosContext.Instance.CasinosLua:doString("ViewBase")
	CS.Casinos.CasinosContext.Instance.CasinosLua:doString("ViewFactory")
end
