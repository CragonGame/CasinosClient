...
{
    unsafe class MessagePack_Formatters_PrimitiveObjectFormatter_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(MessagePack.Formatters.PrimitiveObjectFormatter);
            args = new Type[]{typeof(System.Type), typeof(System.Reflection.TypeInfo), typeof(System.Object)};
            method = type.GetMethod("IsSupportedType", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, IsSupportedType_0);
            args = new Type[]{typeof(System.Byte[]).MakeByRefType(), typeof(System.Int32), typeof(System.Object), typeof(MessagePack.IFormatterResolver)};
            ...
            app.RegisterCLRCreateArrayInstance(type, s => new MessagePack.Formatters.PrimitiveObjectFormatter[s]);


        }


        static StackObject* IsSupportedType_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Reflection.TypeInfo @typeInfo = (System.Reflection.TypeInfo)typeof(System.Reflection.TypeInfo).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
            ...
            var result_of_this_method = MessagePack.Formatters.PrimitiveObjectFormatter.IsSupportedType(@type, @typeInfo, @value);
        ...
        static StackObject* Serialize_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            MessagePack.Formatters.PrimitiveObjectFormatter instance_of_this_method = (MessagePack.Formatters.PrimitiveObjectFormatter)typeof(MessagePack.Formatters.PrimitiveObjectFormatter).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        {
            return MessagePack.Formatters.PrimitiveObjectFormatter.Instance;
        }
