...
{
    unsafe class MessagePack_Formatters_UInt64ArrayFormatter_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(MessagePack.Formatters.UInt64ArrayFormatter);
            ...
            app.RegisterCLRCreateArrayInstance(type, s => new MessagePack.Formatters.UInt64ArrayFormatter[s]);
        ...
        static StackObject* Serialize_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.UInt64[] @value = (System.UInt64[])typeof(System.UInt64[]).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            ...
            MessagePack.Formatters.UInt64ArrayFormatter instance_of_this_method = (MessagePack.Formatters.UInt64ArrayFormatter)typeof(MessagePack.Formatters.UInt64ArrayFormatter).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        {
            return MessagePack.Formatters.UInt64ArrayFormatter.Instance;
        }
