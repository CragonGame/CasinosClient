...
namespace Casinos
{
    ...
    public static class CardTypeHelperZhongFB
    {
        //---------------------------------------------------------------------
        private static readonly IHandEvaluatorZhongFB HandEvaluator = new HandEvaluatorZhongFB();
        ...
        public static HandRankTypeZhongFB GetHandRank(ICollection<Card> cards)
        {
            return HandEvaluator.GetBestHand(cards).RankType;
        }

        //---------------------------------------------------------------------
        public static BestHandZhongFB GetBestHand(ICollection<Card> cards)
        {
