        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					System.Collections.Generic.List<string> gen_ret = new System.Collections.Generic.List<string>();
        ...
        static int _m_AsReadOnly(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        System.Collections.ObjectModel.ReadOnlyCollection<string> gen_ret = gen_to_be_invoked.AsReadOnly(  );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    System.Predicate<string> _match = translator.GetDelegate<System.Predicate<string>>(L, 2);
                        ...
                        string gen_ret = gen_to_be_invoked.Find( _match );
		    ...
		    try {
                ...
                
                {
                    System.Predicate<string> _match = translator.GetDelegate<System.Predicate<string>>(L, 2);
                        ...
                        System.Collections.Generic.List<string> gen_ret = gen_to_be_invoked.FindAll( _match );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetEnumerator(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        System.Collections.Generic.List<string>.Enumerator gen_ret = gen_to_be_invoked.GetEnumerator(  );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    int _count = LuaAPI.xlua_tointeger(L, 3);
                        ...
                        System.Collections.Generic.List<string> gen_ret = gen_to_be_invoked.GetRange( _index, _count );
                        translator.Push(L, gen_ret);
        ...
        static int _m_ToArray(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        string[] gen_ret = gen_to_be_invoked.ToArray(  );
                        translator.Push(L, gen_ret);
