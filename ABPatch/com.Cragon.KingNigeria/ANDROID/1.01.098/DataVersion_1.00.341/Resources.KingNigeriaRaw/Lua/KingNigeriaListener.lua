...
function KingNigeriaListener:_regView()
    ...
    CS.Casinos.CasinosContext.Instance.CasinosLua:doString("UiResetPwd")
    CS.Casinos.CasinosContext.Instance.CasinosLua:doString("UiRegister")
    CS.Casinos.CasinosContext.Instance.CasinosLua:doString("UiChooseCountryCode")
    ...
    CS.Casinos.CasinosContext.Instance.CasinosLua:doString("ViewShareType")
    ...
    CS.Casinos.CasinosContext.Instance.CasinosLua:doString("ViewIdCardCheck")
    ...
    CS.Casinos.CasinosContext.Instance.CasinosLua:doString("ViewTimingReward")
    ...
    CS.Casinos.CasinosContext.Instance.CasinosLua:doString("ViewFeedback")
    ...
    CS.Casinos.CasinosContext.Instance.CasinosLua:doString("ItemCountryCode")
...
function KingNigeriaListener:_regController()
    ...
    CS.Casinos.CasinosContext.Instance.CasinosLua:doString("IMFeedback")
    ...
    CS.Casinos.CasinosContext.Instance.CasinosLua:doString("TimingReward")
end
...
function KingNigeriaListener:_addUiPackage()
    ...
    casinos_context.Listener:AddUiPackage(s)
    s = self.ViewMgr:getUiPackagePath("ShareType")
    casinos_context.Listener:AddUiPackage(s)
    ...
    casinos_context.Listener:AddUiPackage(s)
    s = self.ViewMgr:getUiPackagePath("Feedback")
    casinos_context.Listener:AddUiPackage(s)
    s = self.ViewMgr:getUiPackagePath("InviteFriendPlay")
    casinos_context.Listener:AddUiPackage(s)
    s = self.ViewMgr:getUiPackagePath("IdCardCheck")
    casinos_context.Listener:AddUiPackage(s)
...
function KingNigeriaListener:LoadDataDone()
    ...
    CS.Casinos.CasinosContext.Instance.CasinosLua:doString("ModelWallet")
    CS.Casinos.CasinosContext.Instance.CasinosLua:doString("ModelBag")
    CS.Casinos.CasinosContext.Instance.CasinosLua:doString("ModelDesktopH")
    CS.Casinos.CasinosContext.Instance.CasinosLua:doString("ModelIM")
    CS.Casinos.CasinosContext.Instance.CasinosLua:doString("ModelIMClientEvent")
    CS.Casinos.CasinosContext.Instance.CasinosLua:doString("ModelIMMailBox")
    CS.Casinos.CasinosContext.Instance.CasinosLua:doString("ModelLotteryTicket")
    CS.Casinos.CasinosContext.Instance.CasinosLua:doString("ModelPlayer")
    CS.Casinos.CasinosContext.Instance.CasinosLua:doString("ModelPlayerInfo")
