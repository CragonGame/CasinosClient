    ...
    public class SystemTextRegularExpressionsRegexWrap 
    {
        ...
        static int _m_CompileToAssembly_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    System.Text.RegularExpressions.RegexCompilationInfo[] _regexes = (System.Text.RegularExpressions.RegexCompilationInfo[])translator.GetObject(L, 1, typeof(System.Text.RegularExpressions.RegexCompilationInfo[]));
                    System.Reflection.AssemblyName _aname = (System.Reflection.AssemblyName)translator.GetObject(L, 2, typeof(System.Reflection.AssemblyName));
                    
                    System.Text.RegularExpressions.Regex.CompileToAssembly( _regexes, _aname );
                ...
                if(gen_param_count == 3&& translator.Assignable<System.Text.RegularExpressions.RegexCompilationInfo[]>(L, 1)&& translator.Assignable<System.Reflection.AssemblyName>(L, 2)&& translator.Assignable<System.Reflection.Emit.CustomAttributeBuilder[]>(L, 3)) 
                {
                    System.Text.RegularExpressions.RegexCompilationInfo[] _regexes = (System.Text.RegularExpressions.RegexCompilationInfo[])translator.GetObject(L, 1, typeof(System.Text.RegularExpressions.RegexCompilationInfo[]));
                    System.Reflection.AssemblyName _aname = (System.Reflection.AssemblyName)translator.GetObject(L, 2, typeof(System.Reflection.AssemblyName));
                    System.Reflection.Emit.CustomAttributeBuilder[] _attribs = (System.Reflection.Emit.CustomAttributeBuilder[])translator.GetObject(L, 3, typeof(System.Reflection.Emit.CustomAttributeBuilder[]));
                    
                    System.Text.RegularExpressions.Regex.CompileToAssembly( _regexes, _aname, _attribs );
                ...
                if(gen_param_count == 4&& translator.Assignable<System.Text.RegularExpressions.RegexCompilationInfo[]>(L, 1)&& translator.Assignable<System.Reflection.AssemblyName>(L, 2)&& translator.Assignable<System.Reflection.Emit.CustomAttributeBuilder[]>(L, 3)&& (LuaAPI.lua_isnil(L, 4) || LuaAPI.lua_type(L, 4) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    System.Text.RegularExpressions.Regex.CompileToAssembly( _regexes, _aname, _attribs, _resourceFile );
		    ...
		    try {
                ...
                if(gen_param_count == 4&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    int _length = LuaAPI.xlua_tointeger(L, 4);
                        ...
                        System.Text.RegularExpressions.Match gen_ret = gen_to_be_invoked.Match( _input, _startat, _length );
                        translator.Push(L, gen_ret);
