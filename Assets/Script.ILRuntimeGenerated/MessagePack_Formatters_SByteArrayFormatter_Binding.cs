...
{
    unsafe class MessagePack_Formatters_SByteArrayFormatter_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(MessagePack.Formatters.SByteArrayFormatter);
            args = new Type[]{typeof(System.Byte[]).MakeByRefType(), typeof(System.Int32), typeof(System.SByte[]), typeof(MessagePack.IFormatterResolver)};
            ...
            app.RegisterCLRCreateArrayInstance(type, s => new MessagePack.Formatters.SByteArrayFormatter[s]);
        ...
        static StackObject* Serialize_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.SByte[] @value = (System.SByte[])typeof(System.SByte[]).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            ...
            MessagePack.Formatters.SByteArrayFormatter instance_of_this_method = (MessagePack.Formatters.SByteArrayFormatter)typeof(MessagePack.Formatters.SByteArrayFormatter).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        {
            return MessagePack.Formatters.SByteArrayFormatter.Instance;
        }
