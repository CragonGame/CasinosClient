...
function ViewChat:setPresetMsg()
	...
	do
		local msg = value
        if (self.UiChatType == _eUiChatType.Desktop and msg.PresetMsgType == PresetMsgType.DesktopH)
		then
        elseif (self.UiChatType == _eUiChatType.DesktopH and msg.PresetMsgType == PresetMsgType.Desktop)
		then
		else
