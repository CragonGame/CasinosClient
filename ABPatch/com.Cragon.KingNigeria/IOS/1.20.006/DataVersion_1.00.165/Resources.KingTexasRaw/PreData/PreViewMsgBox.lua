...
function PreViewMsgBox:onCreate()	 
	 ...
	 then		
		local tips = "EnsureZh"
		--[[local pack_name = CS.Casinos.CasinosContext.Instance.LanMgr:getLanPackageName()
		if(pack_name == "LanEn")
		then
			tips = "EnsureEn"
		else 
		...
		local loader_confirm = obj_ok:GetChild("LoaderEnsure")
		loader_confirm.icon = CS.FairyGUI.UIPackage.GetItemURL("PreMsgBox", tips)
