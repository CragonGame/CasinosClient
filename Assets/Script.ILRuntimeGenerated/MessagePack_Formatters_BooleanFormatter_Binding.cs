...
{
    unsafe class MessagePack_Formatters_BooleanFormatter_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(MessagePack.Formatters.BooleanFormatter);
            ...
            app.RegisterCLRCreateArrayInstance(type, s => new MessagePack.Formatters.BooleanFormatter[s]);
        ...
        static StackObject* Serialize_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            MessagePack.Formatters.BooleanFormatter instance_of_this_method = (MessagePack.Formatters.BooleanFormatter)typeof(MessagePack.Formatters.BooleanFormatter).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        {
            return MessagePack.Formatters.BooleanFormatter.Instance;
        }
