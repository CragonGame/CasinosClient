...
{
    unsafe class MessagePack_Formatters_UInt32Formatter_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(MessagePack.Formatters.UInt32Formatter);
            ...
            app.RegisterCLRCreateArrayInstance(type, s => new MessagePack.Formatters.UInt32Formatter[s]);
        ...
        static StackObject* Serialize_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            MessagePack.Formatters.UInt32Formatter instance_of_this_method = (MessagePack.Formatters.UInt32Formatter)typeof(MessagePack.Formatters.UInt32Formatter).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        {
            return MessagePack.Formatters.UInt32Formatter.Instance;
        }
