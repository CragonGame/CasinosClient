...
function DesktopHCards:update(elapsed_tm)        
            ...
            then
                ...
                if (self.DealCardTm >= DesktopHCards.DEAL_CARD_TM)
                then
                    self.DealCardTm = 0
            ...
            then
                ...
                if (self.ShowCardTm >= DesktopHCards.SHOW_CARD_TM)
                then
            ...
            then
                ...
                if (self.ShowOneCardInterverTime >= DesktopHCards.ShowOneCardIntervalTm)
                then
...
function DesktopHCards:setCards(list_card)        
    ...
    for i, v in pairs(self.ListCard) do
        ...
        then
            ...
            if (#self.ListDesktopHCard >= #self.ListCard)
            then
...
function DesktopHCards:dealCardAtPos1(deal_cardcount, move_cardwidth_percent)
            ...
            for i = 0,deal_cardcount - 1 do
                ...
                if (self.ListCard ~= nil and #self.ListCard > 0)
                then
