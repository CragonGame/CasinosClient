...
namespace XLua.CSObjectWrap
{
    ...
    public class CasinosCardWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Casinos.Card);
			Utils.BeginObjectRegister(type, L, translator, 0, 5, 2, 0);
			
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetCardData", _m_GetCardData);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "FromHashCode", _m_FromHashCode_xlua_st_);
        ...
        static int _m_DeepClone(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        Casinos.Card gen_ret = gen_to_be_invoked.DeepClone(  );
                        translator.Push(L, gen_ret);
        ...
        static int _g_get_Suit(RealStatePtr L)
        {
		    try {
                ...
                Casinos.Card gen_to_be_invoked = (Casinos.Card)translator.FastGetCSObj(L, 1);
                LuaAPI.xlua_pushinteger(L, gen_to_be_invoked.Suit);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
