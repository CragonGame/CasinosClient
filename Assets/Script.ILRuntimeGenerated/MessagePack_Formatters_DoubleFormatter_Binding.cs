...
{
    unsafe class MessagePack_Formatters_DoubleFormatter_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(MessagePack.Formatters.DoubleFormatter);
            ...
            app.RegisterCLRCreateArrayInstance(type, s => new MessagePack.Formatters.DoubleFormatter[s]);
        ...
        static StackObject* Serialize_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            MessagePack.Formatters.DoubleFormatter instance_of_this_method = (MessagePack.Formatters.DoubleFormatter)typeof(MessagePack.Formatters.DoubleFormatter).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        {
            return MessagePack.Formatters.DoubleFormatter.Instance;
        }
