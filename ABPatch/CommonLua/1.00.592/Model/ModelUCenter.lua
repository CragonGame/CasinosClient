...
-- Conflict - 409
    ...
    WechatAccountCanntAttachWechat = 409002,-- 微信登陆的账号无需再次绑定微信
    AttachWechatExists = 409003,-- 该账号已经绑定微信，无法重复绑定
    AttachWechatAttachCountMax = 409004,-- 该微信绑定账号次数已经达到上限，无法绑定新账号
