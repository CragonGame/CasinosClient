...
function ViewResetPwd:onCreate()
    ...
    text_acc.promptText = self.ViewMgr.LanMgr:getLanValue("�������û���", "InputUserName")
    ...
    text_superpwd.promptText = self.ViewMgr.LanMgr:getLanValue("�����볬������", "InputSuperPwd")
    ...
    text_confirmnewpwd.promptText = self.ViewMgr.LanMgr:getLanValue("��ȷ��������", "ConfirmNewPwd")
