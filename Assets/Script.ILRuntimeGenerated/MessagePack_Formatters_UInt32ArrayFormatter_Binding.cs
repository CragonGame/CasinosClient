...
{
    unsafe class MessagePack_Formatters_UInt32ArrayFormatter_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(MessagePack.Formatters.UInt32ArrayFormatter);
            args = new Type[]{typeof(System.Byte[]).MakeByRefType(), typeof(System.Int32), typeof(System.UInt32[]), typeof(MessagePack.IFormatterResolver)};
            ...
            app.RegisterCLRCreateArrayInstance(type, s => new MessagePack.Formatters.UInt32ArrayFormatter[s]);
        ...
        static StackObject* Serialize_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.UInt32[] @value = (System.UInt32[])typeof(System.UInt32[]).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            ...
            MessagePack.Formatters.UInt32ArrayFormatter instance_of_this_method = (MessagePack.Formatters.UInt32ArrayFormatter)typeof(MessagePack.Formatters.UInt32ArrayFormatter).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        {
            return MessagePack.Formatters.UInt32ArrayFormatter.Instance;
        }
