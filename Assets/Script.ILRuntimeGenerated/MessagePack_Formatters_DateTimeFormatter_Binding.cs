...
{
    unsafe class MessagePack_Formatters_DateTimeFormatter_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(MessagePack.Formatters.DateTimeFormatter);
            ...
            app.RegisterCLRCreateArrayInstance(type, s => new MessagePack.Formatters.DateTimeFormatter[s]);
        ...
        static StackObject* Serialize_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            MessagePack.Formatters.DateTimeFormatter instance_of_this_method = (MessagePack.Formatters.DateTimeFormatter)typeof(MessagePack.Formatters.DateTimeFormatter).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        {
            return MessagePack.Formatters.DateTimeFormatter.Instance;
        }
