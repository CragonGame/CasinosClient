...
function ViewRanking:onHandleEv(ev)
	...
	then
		...
		elseif(ev.EventName == "EvEntityGetRankingRedEnvelopes")
		then
...
function ViewRanking:RenderListItem(index,obj)
	...
	if(self.RankingListType == RankingListType.Chip)
	then
	...
	elseif(self.RankingListType == RankingListType.Gold)
	then
	...
	elseif(self.RankingListType == RankingListType.Level)
	then
	...
	elseif(self.RankingListType == RankingListType.Gift)
	then
	elseif(self.RankingListType == RankingListType.WinGold)
	then
		...
		if (self.ControllerRanking.ListRankingRedEnvelopes ~= nil)
		then
			if (#self.ControllerRanking.ListRankingRedEnvelopes > index)
			then
