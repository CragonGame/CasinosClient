...
{
    unsafe class MessagePack_Formatters_NilFormatter_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(MessagePack.Formatters.NilFormatter);
            args = new Type[]{typeof(System.Byte[]).MakeByRefType(), typeof(System.Int32), typeof(MessagePack.Nil), typeof(MessagePack.IFormatterResolver)};
            ...
            app.RegisterCLRCreateArrayInstance(type, s => new MessagePack.Formatters.NilFormatter[s]);
        ...
        static StackObject* Serialize_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            MessagePack.IFormatterResolver @typeResolver = (MessagePack.IFormatterResolver)typeof(MessagePack.IFormatterResolver).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));

            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            MessagePack.Nil @value = (MessagePack.Nil)typeof(MessagePack.Nil).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            ...
            MessagePack.Formatters.NilFormatter instance_of_this_method = (MessagePack.Formatters.NilFormatter)typeof(MessagePack.Formatters.NilFormatter).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));

            var result_of_this_method = instance_of_this_method.Serialize(ref @bytes, @offset, @value, @typeResolver);
        ...
        static StackObject* Deserialize_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = instance_of_this_method.Deserialize(@bytes, @offset, @typeResolver, out @readSize);
        ...
        {
            return MessagePack.Formatters.NilFormatter.Instance;
        }
