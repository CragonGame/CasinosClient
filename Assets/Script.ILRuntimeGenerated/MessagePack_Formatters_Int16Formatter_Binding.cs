...
{
    unsafe class MessagePack_Formatters_Int16Formatter_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(MessagePack.Formatters.Int16Formatter);
            ...
            app.RegisterCLRCreateArrayInstance(type, s => new MessagePack.Formatters.Int16Formatter[s]);
        ...
        static StackObject* Serialize_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            MessagePack.Formatters.Int16Formatter instance_of_this_method = (MessagePack.Formatters.Int16Formatter)typeof(MessagePack.Formatters.Int16Formatter).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        {
            return MessagePack.Formatters.Int16Formatter.Instance;
        }
