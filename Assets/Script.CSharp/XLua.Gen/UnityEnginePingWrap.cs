...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEnginePingWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityEngine.Ping);
			Utils.BeginObjectRegister(type, L, translator, 0, 1, 3, 0);
			
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "DestroyPing", _m_DestroyPing);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING))
				{
					...
					UnityEngine.Ping gen_ret = new UnityEngine.Ping(_address);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Ping constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DestroyPing(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Ping gen_to_be_invoked = (UnityEngine.Ping)translator.FastGetCSObj(L, 1);
            
            
                
                {
                    
                    gen_to_be_invoked.DestroyPing(  );
