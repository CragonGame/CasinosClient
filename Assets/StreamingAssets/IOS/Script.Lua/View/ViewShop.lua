    ...
    if (goodsType == GoodsType.Gift1) then
        ...
        for key, value in pairs(t) do
            ...
            if (tb_item.UnitType == "GoodsVoucher") then
                ...
                local url = CS.Casinos.CasinosContext.Instance.PathMgr:combinePersistentDataPath(CS.Casinos.UiHelperCasinos:getABItemResourceTitlePath() .. tostring(tb_item.Icon) .. ".ab")
