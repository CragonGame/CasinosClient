...
namespace XLua.CSObjectWrap
{
    ...
    public class CasinosLuaMgrWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "WriteFileFromBytes", _m_WriteFileFromBytes);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_WWWLoadTextAsync(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.WWWLoadTextAsync( _url, _cb );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_WWWLoadTextureAsync(RealStatePtr L)
        {
		    try {
                ...
                {
                    string _url = LuaAPI.lua_tostring(L, 2);
                    System.Action<UnityEngine.Texture> _cb = translator.GetDelegate<System.Action<UnityEngine.Texture>>(L, 3);
                    
                    gen_to_be_invoked.WWWLoadTextureAsync( _url, _cb );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_WWWLoadAssetBundleAsync(RealStatePtr L)
        {
		    try {
                ...
                {
                    string _url = LuaAPI.lua_tostring(L, 2);
                    System.Action<UnityEngine.AssetBundle> _cb = translator.GetDelegate<System.Action<UnityEngine.AssetBundle>>(L, 3);
                    
                    gen_to_be_invoked.WWWLoadAssetBundleAsync( _url, _cb );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_WriteFileFromBytes(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.WriteFileFromBytes( _path, _bytes );
