...
{
    unsafe class MessagePack_Formatters_UInt16Formatter_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(MessagePack.Formatters.UInt16Formatter);
            ...
            app.RegisterCLRCreateArrayInstance(type, s => new MessagePack.Formatters.UInt16Formatter[s]);
        ...
        static StackObject* Serialize_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            MessagePack.Formatters.UInt16Formatter instance_of_this_method = (MessagePack.Formatters.UInt16Formatter)typeof(MessagePack.Formatters.UInt16Formatter).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        {
            return MessagePack.Formatters.UInt16Formatter.Instance;
        }
