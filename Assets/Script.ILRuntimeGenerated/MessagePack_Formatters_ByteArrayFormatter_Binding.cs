...
{
    unsafe class MessagePack_Formatters_ByteArrayFormatter_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(MessagePack.Formatters.ByteArrayFormatter);
            args = new Type[]{typeof(System.Byte[]).MakeByRefType(), typeof(System.Int32), typeof(System.Byte[]), typeof(MessagePack.IFormatterResolver)};
            ...
            app.RegisterCLRCreateArrayInstance(type, s => new MessagePack.Formatters.ByteArrayFormatter[s]);
        ...
        static StackObject* Serialize_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            MessagePack.Formatters.ByteArrayFormatter instance_of_this_method = (MessagePack.Formatters.ByteArrayFormatter)typeof(MessagePack.Formatters.ByteArrayFormatter).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        {
            return MessagePack.Formatters.ByteArrayFormatter.Instance;
        }
