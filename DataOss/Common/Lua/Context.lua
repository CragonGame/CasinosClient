...
function Context:_regView()
    ...
    self:DoString("UiLotteryTicketBase")
    self:DoString("UiLotteryTicketBetOperateItem")
    self:DoString("UiLotteryTicketBetPotItem")
    self:DoString("UiLotteryTicketCard")
    self:DoString("UiLotteryTicketFlow")
    self:DoString("UiLotteryTicketGFlower")
    self:DoString("UiLotteryTicketTexas")
    ...
    self:DoString("UiDesktopHGold")
    self:DoString("UiDesktopHDealer")
    self:DoString("UiDesktopHBanker")
    self:DoString("UiDesktopHCard")
    self:DoString("UiDesktopHCards")
    self:DoString("UiDesktopHCardTypeBase")
    self:DoString("UiDesktopHCardTypeTexas")
    self:DoString("UiDesktopHGoldPool")
    self:DoString("UiDesktopHRewardPot")
    self:DoString("UiDesktopHMe")
    self:DoString("UiDesktopHStandPlayer")
    self:DoString("UiDesktopHChair")
    self:DoString("UiDesktopHBetPot")
    ...
    --Item
    self:DoString("UiDesktopHBetOperateItem")
    self:DoString("UiDesktopHBetPotItem")
    self:DoString("UiDesktopHHistroy")
    self:DoString("UiDesktopHSeat")
    self:DoString("UiDesktopHTongPei")
    self:DoString("UiDesktopHTongSha")
